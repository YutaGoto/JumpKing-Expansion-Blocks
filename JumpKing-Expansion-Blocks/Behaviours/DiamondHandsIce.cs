...
{
    internal class DiamondHandsIce: IBlockBehaviour
    {
        public float BlockPriority => 2f;

        public bool IsPlayerOnBlock { get; set; } = false;

        public DiamondHandsIce() { }
        ...
        public bool ExecuteBlockBehaviour(BehaviourContext behaviourContext)
        {
            ...
            {
                IsPlayerOnBlock = behaviourContext.CollisionInfo.PreResolutionCollisionInfo.IsCollidingWith<Blocks.DiamondHandsIce>();
            }
