...
{
    public class LightWallJump: IBlockBehaviour
    {
        ...
        public LightWallJump(ICollisionQuery collisionQuery)
        {
        ...
        public bool AdditionalXCollisionCheck(AdvCollisionInfo info, BehaviourContext behaviourContext)
        {
            ...
            if (info.IsCollidingWith<Blocks.LightWallJump>() && !IsPlayerOnBlock)
            {
        ...
        public bool ExecuteBlockBehaviour(BehaviourContext behaviourContext)
        {
            ...
            IsPlayerOnBlock = info.IsCollidingWith<Blocks.LightWallJump>();
            if (IsPlayerOnBlock)
            {
