...
{
    internal class DisabledSmallJump: IBlock, IBlockDebugColor
    {
        private readonly Rectangle m_collider;

        public DisabledSmallJump(Rectangle collider) { m_collider = collider; }

        public Color DebugColor { get { return Constants.ColorCodes.CODE_DISABLED_SMALL_JUMP; } }
