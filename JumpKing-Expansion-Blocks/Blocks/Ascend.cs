...
{
    internal class Ascend : IBlock, IBlockDebugColor
    {
        private readonly Rectangle m_collider;

        public Ascend(Rectangle collider) { m_collider = collider; }

        public Color DebugColor { get { return Constants.ColorCodes.CODE_ASCEND; } }
