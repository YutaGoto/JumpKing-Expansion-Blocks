...
{
    internal class SlideOn: IBlock, IBlockDebugColor
    {
        private readonly Rectangle m_collider;

        public SlideOn(Rectangle p_collider)
        {
            m_collider = p_collider;
        }

        public Color DebugColor { get { return Constants.ColorCodes.CODE_SLIDE_ON; } }
