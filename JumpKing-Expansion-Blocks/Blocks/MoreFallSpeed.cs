...
{
    internal class MoreFallSpeed: IBlock, IBlockDebugColor
    {
        private readonly Rectangle m_collider;

        public MoreFallSpeed(Rectangle p_collider) { m_collider = p_collider; }

        public Color DebugColor { get { return Constants.ColorCodes.CODE_MORE_FALL_SPEED; } }
