...
{
    internal class MoveUp : IBlock, IBlockDebugColor
    {
        private readonly Rectangle m_collider;

        public MoveUp(Rectangle collider) { m_collider = collider; }

        public Color DebugColor { get { return Constants.ColorCodes.CODE_MOVE_UP; } }
