...
{
    internal class SuperLowGravity: IBlock, IBlockDebugColor
    {
        private readonly Rectangle m_collider;

        public SuperLowGravity(Rectangle collider) { m_collider = collider; }

        public Color DebugColor { get { return Constants.ColorCodes.CODE_SUPER_LOW_GRAVITY; } }
